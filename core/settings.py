...
ALLOWED_HOSTS = ['*']  # For POC - in production use specific domains
...
# ChromaDB settings - persistent storage for vector embeddings
...
if not DEBUG:
    ...
    SECURE_SSL_REDIRECT = False  # Platform handles SSL
